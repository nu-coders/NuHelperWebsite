                      ...
                      {tables &&
                        tables.map((course, index) => {
                          ...
                          return (
                            <Paper
                              key={index}
                              sx={{ borderRadius: 25, m: 2, alignItems: 'center' }}
                              alignItems='center'
                              justify='center'
                            >
                              <Paper
                              ...
                              >
                                ...
                                <Typography>
                                  {' '}
                                  {course.courseType + ' ' + course.section}{' '}
                                </Typography>
                              </Paper>
                              <Paper
                                key={index}
                                sx={{
                                  ...
                                  p: 2,
                                  backgroundColor: colors[course.courseType],
                                  alignItems: 'center',
                                }}
                                alignItems='center'
                                justify='center'
                              >
                                  ...
                                  course.schedule.map((schedule, index) => {
                                    return (
                                      <span>
                                        ...
                                        <Typography>
                                          {' '}
                                          {schedule.bldgName + ' - Room ' + schedule.roomId}{' '}
                                        </Typography>
                                      </span>
                                    );
                                  })}
                                <Typography>
                                  {' '}
                                  Instructor :
                                  {(course.instructors && course.instructors[0].fullName) || 'NULL'}
                                </Typography>
